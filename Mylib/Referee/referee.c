...
void Mainfold_Receive_Configuration(void){
    ...
    DMA_Init(DMA1_Stream6, &DMA_InitStructure);
		...
		NVIC_InitStructure.NVIC_IRQChannel = USART2_IRQn;  //TIM3÷–∂œ
		NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1;  //œ»’º”≈œ»º∂0º∂
		NVIC_InitStructure.NVIC_IRQChannelSubPriority = 1;  //¥””≈œ»º∂3º∂
    ...
    DMA_ITConfig(DMA1_Stream6,DMA_IT_TC,ENABLE);//DMA∑¢ÀÕ÷–∂œ
